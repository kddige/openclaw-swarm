...
OpenClaw Swarm connects to your [OpenClaw Gateway](https://github.com/kddige/openclaw-gateway) instances over WebSocket. You can connect to as many gateways as you need — production, staging, development, all at once.
